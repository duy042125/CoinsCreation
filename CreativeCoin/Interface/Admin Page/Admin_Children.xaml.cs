...
namespace Interface
{
    ...
    public partial class Admin_Children : Window
    {
        ...
        {
            DataTable.ItemsSource = DBConnection.retrieveAllChildren();
        }
        ...
        private void Edit_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                Child data = (Child)DataTable.SelectedItem;
                if (data != null)
                {
                    DBConnection.updateChildByKeys(data);
