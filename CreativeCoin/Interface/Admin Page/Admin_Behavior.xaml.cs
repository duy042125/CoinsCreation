...
namespace Interface
{
    ...
    public partial class Admin_Behavior : Window
    {
        ...
        {
            DataTable.ItemsSource = DBConnection.retrieveAllBehaviors();
        }
        ...
        private void Edit_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                Behavior data = (Behavior)DataTable.SelectedItem;
                if (data != null)
                {
                    DBConnection.updateBehaviorByKeys(data);
        ...
        private void Delete_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                {
                    Behavior data = (Behavior)DataTable.SelectedItem;
                    DBConnection.deleteBehavior(data);
